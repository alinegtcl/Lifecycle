...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Thread {
            sleep(3000)
            // comentado porque isso causa crash quando chamado direto, pois somente a thread que criou é que pode alterar o valor
            // activityMainBinding.nameEt.setText("SDM")

            // segunda tentativa, sucesso, utilizando um handler "implícito" existente, numa thread de user interface
            // runOnUiThread {
            //  activityMainBinding.nameEt.setText("SDM")
            // }

            //mais elegante ter um handler
            nameHandler.also {
